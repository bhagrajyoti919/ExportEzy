...
const TestClientsSimple = () => {
  console.log('TestClientsSimple component rendering...');
  
  return (
    <div style={{ padding: '20px', backgroundColor: '#f0f0f0', minHeight: '100vh' }}>
      <h1 style={{ color: 'blue', fontSize: '24px' }}>Clients Page - Working!</h1>
      <div style={{ backgroundColor: 'white', padding: '20px', margin: '20px 0', borderRadius: '8px' }}>
        <h2>Client Directory</h2>
        <p>This is the clients page and it's working properly.</p>
...
export default TestClientsSimple;
